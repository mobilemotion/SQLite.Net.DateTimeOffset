...
namespace SQLite.Net.DateTimeOffset.PostBuild.Extensions
{
	...
	internal static class ModuleDefinitionExtensions
	{
		...
		/// <param name="log"></param>
		/// <returns></returns>
		internal static MethodReference FindDateTimeOffsetParseExactMethod(this ModuleDefinition module, TaskLoggingHelper log)
		{
		...
		/// <param name="log"></param>
		/// <returns></returns>
		internal static MethodReference FindInvariantCultureGetterMethod(this ModuleDefinition module, TaskLoggingHelper log)
		{
		...
		/// <param name="log"></param>
		/// <returns></returns>
		internal static MethodReference FindIgnoreAttributeCtorMethod(this ModuleDefinition module, TaskLoggingHelper log)
		{
		...
		/// <param name="log"></param>
		/// <returns></returns>
		internal static MethodReference FindColumnAttributeCtorMethod(this ModuleDefinition module, TaskLoggingHelper log)
		{
